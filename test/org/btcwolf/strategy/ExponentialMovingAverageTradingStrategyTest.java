...
//                strategyProvider.buildExponentialMovingAverageStrategy(i,j, false);
    ...
    public void testExponentialMovingAverageStrategyWithPlot() throws InterruptedException {
        ...
        int[] indexes = StrategyTestHelper.getIndexes(2600, maxIndex); //{199, 699 }, {10557, 11057};// {9389, 9689};{12202 , 12502};//
    ...
    private static void cleanLogFiles() {
        try {
            new PrintWriter(new File("./log/BTCWolf.log")).close();
            new PrintWriter(new File("./log/BTCWolf_debug.log")).close();
